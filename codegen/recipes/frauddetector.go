...
func FraudDetectorResources() []*Resource {
	...
	return []*Resource{
		...
		},
		{
			...
			ExtraColumns: append(extraColumns, []codegen.ColumnDefinition{
				tagsCol,
				{
		...
		},
		{
			...
			ExtraColumns: append(extraColumns, []codegen.ColumnDefinition{
				tagsCol,
				{
					Name:     ohResourceTypeColumn,
					Type:     schema.TypeString,
					Resolver: `client.StaticValueResolver("AWS::FraudDetector::EntityType")`,
				},
			}...),
			SkipFields: skipFields,
		},
		...
		},
		{
			...
			ExtraColumns: append(extraColumns, []codegen.ColumnDefinition{
				tagsCol,
				{
					Name:     ohResourceTypeColumn,
					Type:     schema.TypeString,
					Resolver: `client.StaticValueResolver("AWS::FraudDetector::Outcome")`,
				},
			}...),
			SkipFields: skipFields,
		},
		...
		},
		{
			...
			ExtraColumns: append(extraColumns, []codegen.ColumnDefinition{
				tagsCol,
				{
					Name:     ohResourceTypeColumn,
					Type:     schema.TypeString,
					Resolver: `client.StaticValueResolver("AWS::FraudDetector::Variable")`,
				},
			}...),
			SkipFields: skipFields,
		},
