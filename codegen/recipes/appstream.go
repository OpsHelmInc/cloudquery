			...
			ExtraColumns: append(
				...
				[]codegen.ColumnDefinition{
					...
					},
					{
						Name:     ohResourceTypeColumn,
						Type:     schema.TypeString,
						Resolver: `client.StaticValueResolver("AWS::AppStream::ImageBuilder")`,
					},
				}...),
			ShouldGenerateResolverAndMockTest: true,
		},
			...
			ExtraColumns: append(
				...
				[]codegen.ColumnDefinition{
					...
					},
					{
						Name:     ohResourceTypeColumn,
						Type:     schema.TypeString,
						Resolver: `client.StaticValueResolver("AWS::AppStream::Stack")`,
					},
				}...),
			Relations: []string{
				`StackEntitlements()`,
			...
			ExtraColumns: append(
				...
				[]codegen.ColumnDefinition{
					...
					},
					{
						Name:     ohResourceTypeColumn,
						Type:     schema.TypeString,
						Resolver: `client.StaticValueResolver("AWS::AppStream::User")`,
					},
				}...),
			ShouldGenerateResolverAndMockTest: false,
		},
