...
require (
	github.com/OpsHelmInc/ohaws v0.2.2-0.20240711020542-d04f0ecc7ef5
...
replace github.com/cloudquery/plugin-sdk/v4 => github.com/OpsHelmInc/cloudquery-plugin-sdk/v4 v4.58.0
