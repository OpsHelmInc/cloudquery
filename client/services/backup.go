...
type BackupClient interface {
	...
	GetRecoveryPointIndexDetails(context.Context, *backup.GetRecoveryPointIndexDetailsInput, ...func(*backup.Options)) (*backup.GetRecoveryPointIndexDetailsOutput, error)
	...
	GetRestoreJobMetadata(context.Context, *backup.GetRestoreJobMetadataInput, ...func(*backup.Options)) (*backup.GetRestoreJobMetadataOutput, error)
	GetRestoreTestingInferredMetadata(context.Context, *backup.GetRestoreTestingInferredMetadataInput, ...func(*backup.Options)) (*backup.GetRestoreTestingInferredMetadataOutput, error)
	GetRestoreTestingPlan(context.Context, *backup.GetRestoreTestingPlanInput, ...func(*backup.Options)) (*backup.GetRestoreTestingPlanOutput, error)
	GetRestoreTestingSelection(context.Context, *backup.GetRestoreTestingSelectionInput, ...func(*backup.Options)) (*backup.GetRestoreTestingSelectionOutput, error)
	...
	ListIndexedRecoveryPoints(context.Context, *backup.ListIndexedRecoveryPointsInput, ...func(*backup.Options)) (*backup.ListIndexedRecoveryPointsOutput, error)
