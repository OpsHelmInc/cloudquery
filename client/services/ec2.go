...
type Ec2Client interface {
	...
	DescribeCapacityManagerDataExports(context.Context, *ec2.DescribeCapacityManagerDataExportsInput, ...func(*ec2.Options)) (*ec2.DescribeCapacityManagerDataExportsOutput, error)
	...
	DescribeServiceLinkVirtualInterfaces(context.Context, *ec2.DescribeServiceLinkVirtualInterfacesInput, ...func(*ec2.Options)) (*ec2.DescribeServiceLinkVirtualInterfacesOutput, error)
	...
	GetCapacityManagerAttributes(context.Context, *ec2.GetCapacityManagerAttributesInput, ...func(*ec2.Options)) (*ec2.GetCapacityManagerAttributesOutput, error)
	GetCapacityManagerMetricData(context.Context, *ec2.GetCapacityManagerMetricDataInput, ...func(*ec2.Options)) (*ec2.GetCapacityManagerMetricDataOutput, error)
	GetCapacityManagerMetricDimensions(context.Context, *ec2.GetCapacityManagerMetricDimensionsInput, ...func(*ec2.Options)) (*ec2.GetCapacityManagerMetricDimensionsOutput, error)
	...
	GetRouteServerAssociations(context.Context, *ec2.GetRouteServerAssociationsInput, ...func(*ec2.Options)) (*ec2.GetRouteServerAssociationsOutput, error)
	GetRouteServerPropagations(context.Context, *ec2.GetRouteServerPropagationsInput, ...func(*ec2.Options)) (*ec2.GetRouteServerPropagationsOutput, error)
	GetRouteServerRoutingDatabase(context.Context, *ec2.GetRouteServerRoutingDatabaseInput, ...func(*ec2.Options)) (*ec2.GetRouteServerRoutingDatabaseOutput, error)
