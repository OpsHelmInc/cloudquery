...
type GlueClient interface {
	...
	BatchGetDataQualityResult(context.Context, *glue.BatchGetDataQualityResultInput, ...func(*glue.Options)) (*glue.BatchGetDataQualityResultOutput, error)
	...
	BatchGetTableOptimizer(context.Context, *glue.BatchGetTableOptimizerInput, ...func(*glue.Options)) (*glue.BatchGetTableOptimizerOutput, error)
	...
	DescribeConnectionType(context.Context, *glue.DescribeConnectionTypeInput, ...func(*glue.Options)) (*glue.DescribeConnectionTypeOutput, error)
	DescribeEntity(context.Context, *glue.DescribeEntityInput, ...func(*glue.Options)) (*glue.DescribeEntityOutput, error)
	DescribeInboundIntegrations(context.Context, *glue.DescribeInboundIntegrationsInput, ...func(*glue.Options)) (*glue.DescribeInboundIntegrationsOutput, error)
	...
	GetCatalog(context.Context, *glue.GetCatalogInput, ...func(*glue.Options)) (*glue.GetCatalogOutput, error)
	...
	GetColumnStatisticsTaskRun(context.Context, *glue.GetColumnStatisticsTaskRunInput, ...func(*glue.Options)) (*glue.GetColumnStatisticsTaskRunOutput, error)
	GetColumnStatisticsTaskRuns(context.Context, *glue.GetColumnStatisticsTaskRunsInput, ...func(*glue.Options)) (*glue.GetColumnStatisticsTaskRunsOutput, error)
	GetColumnStatisticsTaskSettings(context.Context, *glue.GetColumnStatisticsTaskSettingsInput, ...func(*glue.Options)) (*glue.GetColumnStatisticsTaskSettingsOutput, error)
	...
	GetDataQualityModel(context.Context, *glue.GetDataQualityModelInput, ...func(*glue.Options)) (*glue.GetDataQualityModelOutput, error)
	GetDataQualityModelResult(context.Context, *glue.GetDataQualityModelResultInput, ...func(*glue.Options)) (*glue.GetDataQualityModelResultOutput, error)
	GetDataQualityResult(context.Context, *glue.GetDataQualityResultInput, ...func(*glue.Options)) (*glue.GetDataQualityResultOutput, error)
	GetDataQualityRuleRecommendationRun(context.Context, *glue.GetDataQualityRuleRecommendationRunInput, ...func(*glue.Options)) (*glue.GetDataQualityRuleRecommendationRunOutput, error)
	GetDataQualityRuleset(context.Context, *glue.GetDataQualityRulesetInput, ...func(*glue.Options)) (*glue.GetDataQualityRulesetOutput, error)
	GetDataQualityRulesetEvaluationRun(context.Context, *glue.GetDataQualityRulesetEvaluationRunInput, ...func(*glue.Options)) (*glue.GetDataQualityRulesetEvaluationRunOutput, error)
	...
	GetUsageProfile(context.Context, *glue.GetUsageProfileInput, ...func(*glue.Options)) (*glue.GetUsageProfileOutput, error)
	...
	ListColumnStatisticsTaskRuns(context.Context, *glue.ListColumnStatisticsTaskRunsInput, ...func(*glue.Options)) (*glue.ListColumnStatisticsTaskRunsOutput, error)
	ListConnectionTypes(context.Context, *glue.ListConnectionTypesInput, ...func(*glue.Options)) (*glue.ListConnectionTypesOutput, error)
	...
	ListDataQualityResults(context.Context, *glue.ListDataQualityResultsInput, ...func(*glue.Options)) (*glue.ListDataQualityResultsOutput, error)
	ListDataQualityRuleRecommendationRuns(context.Context, *glue.ListDataQualityRuleRecommendationRunsInput, ...func(*glue.Options)) (*glue.ListDataQualityRuleRecommendationRunsOutput, error)
	ListDataQualityRulesetEvaluationRuns(context.Context, *glue.ListDataQualityRulesetEvaluationRunsInput, ...func(*glue.Options)) (*glue.ListDataQualityRulesetEvaluationRunsOutput, error)
	...
	ListDataQualityStatisticAnnotations(context.Context, *glue.ListDataQualityStatisticAnnotationsInput, ...func(*glue.Options)) (*glue.ListDataQualityStatisticAnnotationsOutput, error)
	ListDataQualityStatistics(context.Context, *glue.ListDataQualityStatisticsInput, ...func(*glue.Options)) (*glue.ListDataQualityStatisticsOutput, error)
	ListDevEndpoints(context.Context, *glue.ListDevEndpointsInput, ...func(*glue.Options)) (*glue.ListDevEndpointsOutput, error)
	ListEntities(context.Context, *glue.ListEntitiesInput, ...func(*glue.Options)) (*glue.ListEntitiesOutput, error)
