...
type GuarddutyClient interface {
	...
	GetCoverageStatistics(context.Context, *guardduty.GetCoverageStatisticsInput, ...func(*guardduty.Options)) (*guardduty.GetCoverageStatisticsOutput, error)
	...
	GetMalwareProtectionPlan(context.Context, *guardduty.GetMalwareProtectionPlanInput, ...func(*guardduty.Options)) (*guardduty.GetMalwareProtectionPlanOutput, error)
	...
	GetOrganizationStatistics(context.Context, *guardduty.GetOrganizationStatisticsInput, ...func(*guardduty.Options)) (*guardduty.GetOrganizationStatisticsOutput, error)
	...
	ListCoverage(context.Context, *guardduty.ListCoverageInput, ...func(*guardduty.Options)) (*guardduty.ListCoverageOutput, error)
