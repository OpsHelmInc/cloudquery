...
type Sesv2Client interface {
	...
	GetExportJob(context.Context, *sesv2.GetExportJobInput, ...func(*sesv2.Options)) (*sesv2.GetExportJobOutput, error)
	GetImportJob(context.Context, *sesv2.GetImportJobInput, ...func(*sesv2.Options)) (*sesv2.GetImportJobOutput, error)
	GetMessageInsights(context.Context, *sesv2.GetMessageInsightsInput, ...func(*sesv2.Options)) (*sesv2.GetMessageInsightsOutput, error)
	GetMultiRegionEndpoint(context.Context, *sesv2.GetMultiRegionEndpointInput, ...func(*sesv2.Options)) (*sesv2.GetMultiRegionEndpointOutput, error)
	...
	ListExportJobs(context.Context, *sesv2.ListExportJobsInput, ...func(*sesv2.Options)) (*sesv2.ListExportJobsOutput, error)
