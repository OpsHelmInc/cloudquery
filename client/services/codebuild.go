...
type CodebuildClient interface {
	...
	BatchGetCommandExecutions(context.Context, *codebuild.BatchGetCommandExecutionsInput, ...func(*codebuild.Options)) (*codebuild.BatchGetCommandExecutionsOutput, error)
	...
	BatchGetSandboxes(context.Context, *codebuild.BatchGetSandboxesInput, ...func(*codebuild.Options)) (*codebuild.BatchGetSandboxesOutput, error)
	...
	ListCommandExecutionsForSandbox(context.Context, *codebuild.ListCommandExecutionsForSandboxInput, ...func(*codebuild.Options)) (*codebuild.ListCommandExecutionsForSandboxOutput, error)
	...
	ListSandboxes(context.Context, *codebuild.ListSandboxesInput, ...func(*codebuild.Options)) (*codebuild.ListSandboxesOutput, error)
	ListSandboxesForProject(context.Context, *codebuild.ListSandboxesForProjectInput, ...func(*codebuild.Options)) (*codebuild.ListSandboxesForProjectOutput, error)
