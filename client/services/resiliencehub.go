...
type ResiliencehubClient interface {
	...
	ListAppAssessmentResourceDrifts(context.Context, *resiliencehub.ListAppAssessmentResourceDriftsInput, ...func(*resiliencehub.Options)) (*resiliencehub.ListAppAssessmentResourceDriftsOutput, error)
