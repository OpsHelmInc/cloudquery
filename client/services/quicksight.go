...
type QuicksightClient interface {
	...
	DescribeBrand(context.Context, *quicksight.DescribeBrandInput, ...func(*quicksight.Options)) (*quicksight.DescribeBrandOutput, error)
	DescribeBrandAssignment(context.Context, *quicksight.DescribeBrandAssignmentInput, ...func(*quicksight.Options)) (*quicksight.DescribeBrandAssignmentOutput, error)
	DescribeBrandPublishedVersion(context.Context, *quicksight.DescribeBrandPublishedVersionInput, ...func(*quicksight.Options)) (*quicksight.DescribeBrandPublishedVersionOutput, error)
	DescribeCustomPermissions(context.Context, *quicksight.DescribeCustomPermissionsInput, ...func(*quicksight.Options)) (*quicksight.DescribeCustomPermissionsOutput, error)
	...
	DescribeDashboardsQAConfiguration(context.Context, *quicksight.DescribeDashboardsQAConfigurationInput, ...func(*quicksight.Options)) (*quicksight.DescribeDashboardsQAConfigurationOutput, error)
	...
	DescribeDefaultQBusinessApplication(context.Context, *quicksight.DescribeDefaultQBusinessApplicationInput, ...func(*quicksight.Options)) (*quicksight.DescribeDefaultQBusinessApplicationOutput, error)
	...
	DescribeQPersonalizationConfiguration(context.Context, *quicksight.DescribeQPersonalizationConfigurationInput, ...func(*quicksight.Options)) (*quicksight.DescribeQPersonalizationConfigurationOutput, error)
	DescribeQuickSightQSearchConfiguration(context.Context, *quicksight.DescribeQuickSightQSearchConfigurationInput, ...func(*quicksight.Options)) (*quicksight.DescribeQuickSightQSearchConfigurationOutput, error)
	...
	ListFoldersForResource(context.Context, *quicksight.ListFoldersForResourceInput, ...func(*quicksight.Options)) (*quicksight.ListFoldersForResourceOutput, error)
	...
	ListTopicReviewedAnswers(context.Context, *quicksight.ListTopicReviewedAnswersInput, ...func(*quicksight.Options)) (*quicksight.ListTopicReviewedAnswersOutput, error)
	...
	SearchTopics(context.Context, *quicksight.SearchTopicsInput, ...func(*quicksight.Options)) (*quicksight.SearchTopicsOutput, error)
}
