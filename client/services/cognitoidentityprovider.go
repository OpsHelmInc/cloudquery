...
type CognitoidentityproviderClient interface {
	...
	DescribeTerms(context.Context, *cognitoidentityprovider.DescribeTermsInput, ...func(*cognitoidentityprovider.Options)) (*cognitoidentityprovider.DescribeTermsOutput, error)
	...
	ListTerms(context.Context, *cognitoidentityprovider.ListTermsInput, ...func(*cognitoidentityprovider.Options)) (*cognitoidentityprovider.ListTermsOutput, error)
