...
type AppsyncClient interface {
	GetApi(context.Context, *appsync.GetApiInput, ...func(*appsync.Options)) (*appsync.GetApiOutput, error)
	...
	GetChannelNamespace(context.Context, *appsync.GetChannelNamespaceInput, ...func(*appsync.Options)) (*appsync.GetChannelNamespaceOutput, error)
