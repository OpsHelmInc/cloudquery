...
type Inspector2Client interface {
	...
	GetCisScanReport(context.Context, *inspector2.GetCisScanReportInput, ...func(*inspector2.Options)) (*inspector2.GetCisScanReportOutput, error)
	GetCisScanResultDetails(context.Context, *inspector2.GetCisScanResultDetailsInput, ...func(*inspector2.Options)) (*inspector2.GetCisScanResultDetailsOutput, error)
	...
	ListCisScanResultsAggregatedByChecks(context.Context, *inspector2.ListCisScanResultsAggregatedByChecksInput, ...func(*inspector2.Options)) (*inspector2.ListCisScanResultsAggregatedByChecksOutput, error)
	ListCisScanResultsAggregatedByTargetResource(context.Context, *inspector2.ListCisScanResultsAggregatedByTargetResourceInput, ...func(*inspector2.Options)) (*inspector2.ListCisScanResultsAggregatedByTargetResourceOutput, error)
	ListCisScans(context.Context, *inspector2.ListCisScansInput, ...func(*inspector2.Options)) (*inspector2.ListCisScansOutput, error)
