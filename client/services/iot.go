...
type IotClient interface {
	...
	GetCommandExecution(context.Context, *iot.GetCommandExecutionInput, ...func(*iot.Options)) (*iot.GetCommandExecutionOutput, error)
	...
	GetPackageConfiguration(context.Context, *iot.GetPackageConfigurationInput, ...func(*iot.Options)) (*iot.GetPackageConfigurationOutput, error)
	...
	GetThingConnectivityData(context.Context, *iot.GetThingConnectivityDataInput, ...func(*iot.Options)) (*iot.GetThingConnectivityDataOutput, error)
	...
	ListCommandExecutions(context.Context, *iot.ListCommandExecutionsInput, ...func(*iot.Options)) (*iot.ListCommandExecutionsOutput, error)
	...
	ListPrincipalThingsV2(context.Context, *iot.ListPrincipalThingsV2Input, ...func(*iot.Options)) (*iot.ListPrincipalThingsV2Output, error)
	...
	ListSbomValidationResults(context.Context, *iot.ListSbomValidationResultsInput, ...func(*iot.Options)) (*iot.ListSbomValidationResultsOutput, error)
	...
	ListThingPrincipalsV2(context.Context, *iot.ListThingPrincipalsV2Input, ...func(*iot.Options)) (*iot.ListThingPrincipalsV2Output, error)
