...
type CostexplorerClient interface {
	...
	GetApproximateUsageRecords(context.Context, *costexplorer.GetApproximateUsageRecordsInput, ...func(*costexplorer.Options)) (*costexplorer.GetApproximateUsageRecordsOutput, error)
	...
	ListCostAllocationTagBackfillHistory(context.Context, *costexplorer.ListCostAllocationTagBackfillHistoryInput, ...func(*costexplorer.Options)) (*costexplorer.ListCostAllocationTagBackfillHistoryOutput, error)
