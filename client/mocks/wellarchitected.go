...
func (m *MockWellarchitectedClient) GetGlobalSettings(arg0 context.Context, arg1 *wellarchitected.GetGlobalSettingsInput, arg2 ...func(*wellarchitected.Options)) (*wellarchitected.GetGlobalSettingsOutput, error) {
	...
	ret0, _ := ret[0].(*wellarchitected.GetGlobalSettingsOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetGlobalSettings indicates an expected call of GetGlobalSettings.
func (mr *MockWellarchitectedClientMockRecorder) GetGlobalSettings(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetGlobalSettings", reflect.TypeOf((*MockWellarchitectedClient)(nil).GetGlobalSettings), varargs...)
}
