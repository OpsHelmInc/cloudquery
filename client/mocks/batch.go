...
// GetJobQueueSnapshot mocks base method.
func (m *MockBatchClient) GetJobQueueSnapshot(arg0 context.Context, arg1 *batch.GetJobQueueSnapshotInput, arg2 ...func(*batch.Options)) (*batch.GetJobQueueSnapshotOutput, error) {
	...
	if o.Region == "" {
		m.ctrl.T.Errorf("Region not set in call to GetJobQueueSnapshot")
	}
	...
	ret := m.ctrl.Call(m, "GetJobQueueSnapshot", varargs...)
	ret0, _ := ret[0].(*batch.GetJobQueueSnapshotOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetJobQueueSnapshot indicates an expected call of GetJobQueueSnapshot.
func (mr *MockBatchClientMockRecorder) GetJobQueueSnapshot(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetJobQueueSnapshot", reflect.TypeOf((*MockBatchClient)(nil).GetJobQueueSnapshot), varargs...)
}
