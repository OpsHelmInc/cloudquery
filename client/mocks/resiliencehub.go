...
// ListAppAssessmentResourceDrifts mocks base method.
func (m *MockResiliencehubClient) ListAppAssessmentResourceDrifts(arg0 context.Context, arg1 *resiliencehub.ListAppAssessmentResourceDriftsInput, arg2 ...func(*resiliencehub.Options)) (*resiliencehub.ListAppAssessmentResourceDriftsOutput, error) {
	...
	if o.Region == "" {
		m.ctrl.T.Errorf("Region not set in call to ListAppAssessmentResourceDrifts")
	}
	...
	ret := m.ctrl.Call(m, "ListAppAssessmentResourceDrifts", varargs...)
	ret0, _ := ret[0].(*resiliencehub.ListAppAssessmentResourceDriftsOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListAppAssessmentResourceDrifts indicates an expected call of ListAppAssessmentResourceDrifts.
func (mr *MockResiliencehubClientMockRecorder) ListAppAssessmentResourceDrifts(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAppAssessmentResourceDrifts", reflect.TypeOf((*MockResiliencehubClient)(nil).ListAppAssessmentResourceDrifts), varargs...)
}
