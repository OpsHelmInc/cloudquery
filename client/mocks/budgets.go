...
func (m *MockBudgetsClient) ListTagsForResource(arg0 context.Context, arg1 *budgets.ListTagsForResourceInput, arg2 ...func(*budgets.Options)) (*budgets.ListTagsForResourceOutput, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (mr *MockBudgetsClientMockRecorder) ListTagsForResource(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTagsForResource", reflect.TypeOf((*MockBudgetsClient)(nil).ListTagsForResource), varargs...)
}
