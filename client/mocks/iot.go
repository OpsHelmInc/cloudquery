...
// DescribeEncryptionConfiguration mocks base method.
func (m *MockIotClient) DescribeEncryptionConfiguration(arg0 context.Context, arg1 *iot.DescribeEncryptionConfigurationInput, arg2 ...func(*iot.Options)) (*iot.DescribeEncryptionConfigurationOutput, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "DescribeEncryptionConfiguration", varargs...)
	ret0, _ := ret[0].(*iot.DescribeEncryptionConfigurationOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DescribeEncryptionConfiguration indicates an expected call of DescribeEncryptionConfiguration.
func (mr *MockIotClientMockRecorder) DescribeEncryptionConfiguration(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DescribeEncryptionConfiguration", reflect.TypeOf((*MockIotClient)(nil).DescribeEncryptionConfiguration), varargs...)
}
