...
func Operations() *schema.Table {
	...
	return &schema.Table{
		...
		Transform:           transformers.TransformWithStruct(&route53domains.GetOperationDetailOutput{}, transformers.WithSkipFields("ResultMetadata"), transformers.WithPrimaryKeyComponents("OperationId", "Status", "SubmittedDate", "Type")),
